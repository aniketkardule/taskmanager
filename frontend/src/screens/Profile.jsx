...
<div className="h-full lg:w-3/4 md:w-3/4 mx-auto sm:w-full my-10">
 
  <div className="border-b-2 block md:flex p-5">

    <div className="w-full md:w-2/5 p-2 lg:p-8 bg-white shadow-md">
      <div className="flex justify-between">
        <span className="text-xl font-semibold block">My Profile</span>
        <span onClick={ enableUpdate } className="-mt-2 text-md font-bold text-white bg-teal-500 rounded-full px-5 py-2 hover:bg-teal-800 cursor-pointer">Edit</span>
      </div>
     ...
     <Link className="w-full block text-center bg-teal-400 rounded text-white mx-auto px-4 py-2" to="/">Go to tasks</Link>
    </div>
    
    <div className="w-full p-5 md:w-3/5 p-8 bg-white lg:ml-4 shadow-md">
